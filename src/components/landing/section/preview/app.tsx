...
export default function App() {
  ...
  return (
    <div className="relative overflow-hidden flex flex-col md:flex-row min-h-[520px]">
      ...
      <div
        aria-hidden="true"
        className={`absolute inset-0 z-40 bg-black/60 md:hidden transition-opacity duration-200 ${
      ...
      {/* ── Mobile Drawer Panel ────────────────────────────────── */}
      <div
        className={`absolute inset-y-0 left-0 z-50 w-64 bg-[#0e0e10] border-r border-white/[0.06] p-4 flex flex-col md:hidden transition-transform duration-200 ease-in-out ${
