    ...
    <main className="flex-1 p-6 lg:p-10 max-w-6xl mx-auto w-full animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="space-y-8">
        ...
        <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-surface border border-border rounded-2xl p-8 shadow-sm lg:col-span-2">
            {renderProfileSection()}
          </div>
          <div className="bg-surface border border-border rounded-2xl p-8 shadow-sm">
            {renderPreferencesSection()}
          </div>
          <div className="bg-surface border border-border rounded-2xl p-8 shadow-sm md:col-span-2 lg:col-span-3">
